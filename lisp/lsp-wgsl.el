...
(defcustom lsp-wgsl-diagnostics-type-errors nil
...
(defcustom lsp-wgsl-inlayhints-type-verbosity "full"
...
(defun lsp-wgsl--send-configuration (&rest _)
  (list :customImports (list :test "file://home/matt/shader/test.wgsl");;lsp-wgsl-custom-imports
