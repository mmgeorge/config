return {
  {
    ...
    config = function ()
      -- vim.api.nvim_set_hl(0, "OilFloatBg", { bg = "#282c34", sp = "#282c34"  })
      -- vim.api.nvim_set_hl(0, "FloatBorder", { bg = "#282c34" })
      -- vim.api.nvim_set_hl(0, 'NormalFloat', { bg = '#282c34' }) -- A common dark background
      -- vim.api.nvim_set_hl(0, 'FloatBorder', { bg = '#3e4451', fg = '#abb2bf' })
      ...
      require("oil").setup({
        ...
        float = {
          ...
          border = "rounded",
          win_options = {
            -- winhighlight = "NormalFloat:OilFloatBg",
            winblend = 0,
          },
