...
function M.setup()
  ...
  vim.api.nvim_set_hl(0, "ForgeHarnessRecap", { fg = "#9ca3af", italic = true })
  ...
  vim.api.nvim_set_hl(0, "ForgeHarnessSessionName", { fg = "#c0c0c0", italic = true })
  vim.api.nvim_set_hl(0, "ForgeLoading", { fg = "#666666" })
