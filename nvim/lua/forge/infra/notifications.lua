---@class ForgeNotificationsModule
...
---@field format_failures fun(failures: ForgeGitFailure[]): string
---@field git_failures fun(title: string, failures: ForgeGitFailure[])
...
---@param failures ForgeGitFailure[]
---@return string
