...
-- Extmark namespaces.
M.preview_ns = vim.api.nvim_create_namespace("forge_preview")
M.gutter_visual_ns = vim.api.nvim_create_namespace("forge_visual_gutter")
M.hunk_header_ns = vim.api.nvim_create_namespace("forge_headers")
M.active_hunk_header_ns = vim.api.nvim_create_namespace("forge_active_hunk")
M.status_ns = vim.api.nvim_create_namespace("forge_status")
M.status_decorate_ns = vim.api.nvim_create_namespace("forge_status_decorate")
