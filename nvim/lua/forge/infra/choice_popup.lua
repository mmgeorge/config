...
---@class ForgeChoicePopupOptions
---@field title string
---@field options ForgeChoicePopupOption[]
...
---@param opts ForgeChoicePopupOptions
---@return integer buf
