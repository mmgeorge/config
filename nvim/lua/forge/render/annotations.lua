...
local source = require("forge.render.source")

---@alias ForgeAnnotationSide "LEFT"|"RIGHT"|"BOTH"|"old"|"new"|"both"|"file"
---@alias ForgeAnnotationState "clean"|"new"|"dirty"|"syncing"|"failed"|"error"|"deleted"

---@class ForgeDiffAnnotation
---@field id string
---@field kind string?
---@field source_id string?
---@field file_key string?
---@field path string
---@field side ForgeAnnotationSide
---@field line integer
...
---@field state ForgeAnnotationState
...
---@class ForgeAnnotationIndex
---@field by_id table<string, ForgeDiffAnnotation>
---@field by_anchor table<string, ForgeDiffAnnotation[]>
---@field dirty_by_id table<string, boolean>

---@class ForgeAnnotationSyncQueue
---@field pending ForgeDiffAnnotation[]
---@field queued_by_id table<string, boolean>
---@field running boolean
---@field next_operation_id integer
---@field handler fun(annotation: ForgeDiffAnnotation, done: fun(ok: boolean, remote_payload?: table, err?: string))
---@field on_success? fun(annotation: ForgeDiffAnnotation, remote_payload?: table)
---@field on_failure? fun(annotation: ForgeDiffAnnotation, err?: string)
---@field on_idle? fun()
---@field stop_on_failure boolean

---@class ForgeAnnotationModule
local M = {}
...
---@param side ForgeAnnotationSide Side of the diff anchor (`"LEFT"`, `"RIGHT"`, `"BOTH"`).
...
---@return ForgeAnnotationIndex index Empty annotation index structure.
...
---@param bucket ForgeDiffAnnotation[]
---@param id string
...
---@return ForgeAnnotationSide side Canonical annotation side.
...
---@return ForgeAnnotationState state Normalized status string (`"clean"`, `"new"`, `"dirty"`, `"syncing"`, `"failed"`, `"error"`, `"deleted"`).
...
---@param state ForgeAnnotationState Annotation sync status.
...
---@param index ForgeAnnotationIndex Target annotation index.
---@param annotation ForgeDiffAnnotation Annotation record to insert or update.
---@return ForgeDiffAnnotation annotation Normalized inserted annotation record.
...
---@param side ForgeAnnotationSide Anchor diff side.
---@param line integer One-based line number.
---@return ForgeDiffAnnotation[] annotations Array of matching annotations.
...
---@param index ForgeAnnotationIndex Target annotation index.
---@param id string Unique annotation identifier.
---@param state ForgeAnnotationState Next synchronization state.
...
---@param index ForgeAnnotationIndex Target annotation index.
---@return ForgeDiffAnnotation[] annotations Array of dirty annotation records.
...
---@return ForgeAnnotationSyncQueue queue Initialized synchronization queue.
...
---@param annotation ForgeDiffAnnotation Target annotation record.
...
---@param queue ForgeAnnotationSyncQueue Target sync queue.
...
---@param queue ForgeAnnotationSyncQueue Target sync queue.
---@param annotation ForgeDiffAnnotation Target annotation to sync.
