---@class ForgeTextLineSpan
---@field start_offset integer
---@field end_offset integer
---@field newline_offset integer?

---@class ForgeTextSnapshot
---@field text string
---@field line_span ForgeTextLineSpan[]
---@field line_count integer
---@field byte_count integer

---@class ForgeTextSnapshotModule
local M = {}
...
---@return ForgeTextSnapshot snapshot Indexed text snapshot structure.
...
---@param snapshot ForgeTextSnapshot Target text snapshot.
...
---@param snapshot ForgeTextSnapshot Target text snapshot.
---@param line_number integer One-based line index.
---@return ForgeTextLineSpan? span Span record containing byte offsets, or nil.
