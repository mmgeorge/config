...
---@param old_line ForgeParsedHunkLine Deleted line record (`"-"`).
---@param new_line ForgeParsedHunkLine Added line record (`"+"`).
...
---@param lines ForgeParsedHunkLine[] Array of parsed diff hunk lines.
