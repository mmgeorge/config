...
---@field detail? string
---@field children? ForgeTaskTreeNode[]
...
---@return ForgeTaskTreeParsedLine? parsed Structure containing prefixes and body, or nil.
...
---@param row_list ForgeTaskTreeRow[]
---@param node ForgeTaskTreeNode
...
---@param node_list ForgeTaskTreeNode[] Array of task tree root nodes.
---@param width integer Usable column width for wrapping.
---@return ForgeTaskTreeRow[] rows Array of rendered task tree rows.
