...
---@class ForgeSourceLoader
---@field registry ForgeDiffSourceRegistry
---@field source ForgeDiffSourceState

---@class ForgeSourceLoaderModule
local M = {}
...
---@return ForgeSourceLoader loader Bundled registry and source state structure.
...
---@return ForgeDiffFileState file File diff state record.
