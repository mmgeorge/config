...
local hunk_index = require("forge.render.hunk_index")
local syntax_context = require("forge.render.syntax_context")
local text_snapshot = require("forge.render.text_snapshot")

---@alias ForgeDiffSourceKind "unstaged"|"staged"|"commit"|"pr"|"review"|"walkthrough"|"branch"|"working_tree"|"index"|"pull_request"
---@alias ForgeDiffFileStageState "unstaged"|"staged"|"unviewed"|"viewed"|"readonly"

---@class ForgeDiffSourceHandle
---@field id string
---@field kind ForgeDiffSourceKind
---@field label string?
---@field cwd string?
---@field commit_oid string?
---@field lazy boolean?
---@field reload_paths? fun(source: ForgeDiffSourceState, paths: string[], done: fun(ok: boolean, err?: string))
---@field load? fun(source: ForgeDiffSourceState, done: fun(ok: boolean, err?: string))
...
---@class ForgeDisplayHunk
---@field id string
---@field source_id string?
---@field file_key string?
---@field diff string
---@field raw_hunks ForgeRawHunk[]
---@field old_start integer
---@field old_count integer
---@field new_start integer
---@field new_count integer
...
---@class ForgeDiffFileState
---@field key string
---@field source_id string
---@field path string
---@field original_path string?
---@field status string?
---@field stage_state ForgeDiffFileStageState?
---@field added integer
---@field removed integer
---@field expanded boolean
---@field old_text ForgeTextSnapshot?
---@field new_text ForgeTextSnapshot?
...
---@class ForgeDiffSourceState
---@field handle ForgeDiffSourceHandle
---@field loaded boolean
---@field loading boolean
---@field error string?
---@field revision integer
---@field invalidated_path table<string, boolean>
---@field file_by_key table<string, ForgeDiffFileState>
---@field file_order string[]
---@field pending_callback function[]
---@field metadata table

---@class ForgeDiffSourceRegistry
---@field handle_by_id table<string, ForgeDiffSourceHandle>
---@field source_by_id table<string, ForgeDiffSourceState>
...
---@return ForgeDiffSourceRegistry registry Initialized source registry structure.
...
---@param registry ForgeDiffSourceRegistry Target source registry.
---@param handle ForgeDiffSourceHandle Source handle configuration.
---@return ForgeDiffSourceHandle handle Registered source handle descriptor.
...
---@param handle ForgeDiffSourceHandle Source handle configuration.
---@return ForgeDiffSourceState source Initialized diff source state structure.
...
---@param registry ForgeDiffSourceRegistry Target source registry.
---@param handle ForgeDiffSourceHandle Source handle configuration.
---@return ForgeDiffSourceState source Existing or newly created source state record.
...
---@param source ForgeDiffSourceState Target diff source state.
---@param path string Relative file path.
---@param opts? table Optional initial file options.
---@return ForgeDiffFileState file File state structure.
...
---@param file ForgeDiffFileState Target file diff state.
...
---@param file ForgeDiffFileState
---@param side "old"|"new"
---@return ForgeTextSnapshot?
...
---@param file ForgeDiffFileState Target file diff state.
---@param side "old"|"new" Diff side descriptor.
---@param done fun(ok: boolean, snapshot?: ForgeTextSnapshot, err?: string) Completion callback.
...
---@param file ForgeDiffFileState Target file diff state.
---@param hunk ForgeRawHunk Raw hunk descriptor table.
function M.add_raw_hunk(file, hunk)
  ...
  copy.forge_hunk_index = copy.forge_hunk_index or hunk_index.from_hunk(copy)
  file.hunk_index_by_id = file.hunk_index_by_id or {}
  file.hunk_index_by_id[copy.id or tostring(#file.hunks + 1)] = copy.forge_hunk_index
...
---@param source ForgeDiffSourceState Target source state.
...
---@param registry ForgeDiffSourceRegistry
...
---@param registry ForgeDiffSourceRegistry Target source registry.
---@param kind ForgeDiffSourceKind|string Target source kind.
...
---@return ForgeRawHunk[] hunks Array of raw hunk descriptors.
...
---@class ForgeWalkthroughDiffSource : ForgeDiffSourceState
...
---@param handle ForgeDiffSourceHandle? Optional source handle descriptor.
---@param opts? { base_source_ids?: string[], file_order?: string[], step_annotations?: table[] } Walkthrough source options.
---@return ForgeWalkthroughDiffSource source Initialized walkthrough diff source structure.
function M.new_walkthrough_source(handle, opts)
  ...
  local source = M.new_source(handle) --[[@as ForgeWalkthroughDiffSource]]
...
---@param source ForgeWalkthroughDiffSource Target walkthrough source state.
