...
---@alias ForgeSyntaxSide "old"|"new"

---@class ForgeFileSyntaxSide
---@field snapshot ForgeTextSnapshot?
...
---@class ForgeFileSyntaxContext
---@field file_key string
---@field side_by_name table<ForgeSyntaxSide, ForgeFileSyntaxSide>
---@field revision integer

---@class ForgeSyntaxContextModule
local M = {}
...
---@return ForgeFileSyntaxContext context Initialized syntax context structure.
...
---@param context ForgeFileSyntaxContext? Existing context instance or nil.
---@param file_key string Unique composite file identifier.
---@return ForgeFileSyntaxContext context Existing or newly initialized syntax context.
...
---@param context ForgeFileSyntaxContext Target syntax context.
---@param side ForgeSyntaxSide Side descriptor (`"old"` or `"new"`).
---@param snapshot ForgeTextSnapshot? New text snapshot.
