---@class ForgeRowHeightIndex
---@field count integer
---@field total integer
---@field height_by_item integer[]
---@field tree integer[]

---@class ForgeLayoutSpan
---@field key string
---@field start_row integer
---@field height integer
---@field metadata table?

---@class ForgeViewLayout
---@field row_index ForgeRowHeightIndex
---@field span_by_key table<string, ForgeLayoutSpan>
---@field key_by_item string[]
---@field item_index_by_key table<string, integer>

---@class ForgeFileBodyBlock
---@field key string
---@field height integer
---@field kind string?
---@field metadata table?

---@class ForgeFileBodyLayout
---@field blocks ForgeFileBodyBlock[]
---@field view ForgeViewLayout
---@field block_by_key table<string, ForgeFileBodyBlock>

---@class ForgeLayoutModule
local M = {}
...
---@param index ForgeRowHeightIndex Target row height index structure.
...
---@return ForgeRowHeightIndex index Initialized row height index.
...
---@param index ForgeRowHeightIndex Target row height index to reset.
---@param heights integer[] Array of non-negative item heights.
...
---@param index ForgeRowHeightIndex Target row height index.
...
---@return ForgeViewLayout layout Initialized view layout structure.
...
---@param layout ForgeViewLayout Target view layout to rebuild.
...
---@param layout ForgeViewLayout Target view layout.
...
---@param blocks ForgeFileBodyBlock[]? Array of file body block descriptors.
---@return ForgeFileBodyLayout layout Initialized file body layout structure.
...
---@param body_layout ForgeFileBodyLayout Target file body layout.
...
---@param view_layout ForgeViewLayout Target view layout.
---@param first_row integer One-based starting buffer row.
---@param last_row integer One-based ending buffer row.
---@return ForgeLayoutSpan[] spans Array of visible layout span records.
