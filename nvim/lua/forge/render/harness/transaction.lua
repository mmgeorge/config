...
local row_emitter = require("forge.render.row_emitter")
...
---@class ForgeHarnessRenderState: ForgeHarnessPresentationState
---@field render_blocks table[]
---@param state ForgeHarnessRenderState Presentation state table.
