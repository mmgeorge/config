...
--- The primary `:ForgeStatus` buffer's state, kept distinct from `status` so transient
...
---@class ForgeHarnessPresentationState
---@field client table?
---@field ready boolean
---@field busy boolean
...
---@field timeline_status_animated boolean?
...
---@return ForgeHarnessPresentationState state Initialized Harness presentation state table.
...
---@type ForgeHarnessPresentationState
M.harness = new_harness_state()

--- Constructs a fresh Harness presentation state container.
---@return ForgeHarnessPresentationState state Newly initialized presentation state.
...
---@param state ForgeHarnessPresentationState Target presentation state.
...
---@param state ForgeHarnessPresentationState Presentation state record.
