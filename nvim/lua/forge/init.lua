--- Forge — a self-contained, in-editor Git review UI.
---
...
---
--- ===========================================================================
--- USER COMMANDS  (registered in lua/plugins/forge.lua, which calls into
...
---   :ForgeBranchDiffFile <file> <rev>
---       Diff a single file against a branch or revision.
---   :ForgeFileRevision <file> <rev>
...
--- ===========================================================================
--- Configure via require("forge").setup(opts), passed from a lazy.nvim spec.
...
---
---   -- e.g. lua/plugins/forge.lua
---   return {
---     "you/forge",                      -- or `dir = vim.fn.stdpath("config")` for a local plugin
---     cmd = {                                  -- lazy-load on these user commands
---       "ForgeStatus", "ForgeBranchDiff", "ForgeBranchDiffFile",
---       "ForgeFileRevision", "ForgeDiffCompactPreview",
---     },
---     keys = {                                 -- your keys to LAUNCH a view
---       { "<leader>gs", "<cmd>ForgeStatus<cr>", desc = "Git status review" },
---       { "<leader>gd", function() require("forge").open_compact_preview() end,
...
---         status = {                            -- ForgeStatus / PR / branch-diff / diff views
...
---       -- lua/plugins/forge.lua); a packaged plugin would do that in plugin/.
---     end,
---   }
---
...
--- BUFFERS / VIEWS
--- ===========================================================================
---   ForgeStatus       The main review buffer (views/status/*).
---   diff://<file>   Standalone single-file diff with hunk-level stage/unstage.
---   ForgeBranchDiff   Branch / single-file branch diff (a status-style buffer).
---   ForgeFileRevision A file at a past revision, red winbar, read-only.
...
---
--- ===========================================================================
--- ARCHITECTURE  (see lua/forge/docs/architecture.md for the full reference)
--- ===========================================================================
...
--- (`local function owner() return require("forge....") end`), the same
...
require("forge.query_runtime")

local config = require("forge.infra.config")
local highlights = require("forge.infra.highlights")
...
---@alias ForgeDiffSyntaxSide "old"|"new"

---@class ForgeHunkContextPaddingLine
---@field line_number integer
---@field old_line? integer
---@field new_line? integer
---@field text string

---@class ForgeHunkRenderPlan
---@field block ForgeParsedBlock
---@field hunk ForgeParsedHunk
---@field hunk_index integer
---@field region ForgeHunkChangeRegion
---@field region_index integer
---@field region_count integer
---@field render_items table[]
---@field include_render_line fun(parsed_line: ForgeParsedHunkLine): boolean
---@field gutter ForgeGutterSpec
---@field source_lines string[]?
---@field occupied_lines table<integer, boolean>
---@field syntax_by_item table<integer, { syntax?: ForgeTreeSitterSyntax, row?: integer }>
---@field visible_source_lines table<string, boolean>
---@field before_padding_lines ForgeHunkContextPaddingLine[]
---@field after_padding_lines ForgeHunkContextPaddingLine[]
---@field changed_lines table<integer, boolean>
---@field display_start integer?
---@field display_end integer?

---@class ForgeHunkDisplayGroup
---@field plans ForgeHunkRenderPlan[]
---@field gutter ForgeGutterSpec
---@field added integer
---@field removed integer
---@field display_start integer?
...
---@class ForgeSectionConfig
---@field name string
---@field title string
---@field default_folded boolean

---@class ForgeStatusCommandSpec
---@field id string
---@field label string
---@field desc string
...
---@param opts? ForgeConfig User configuration overrides merged into defaults.
...
function M.get(cb, _ctx)
  git_backend.git_root_async(function(cwd)
    ...
    require("forge.git.git_data")._collect_items_from_git(cwd, cb, _ctx)
  end)
end
...
M.open_harness = function() require("forge.views.harness").open() end
M.new_harness_session = function() require("forge.views.harness").new_session() end
M.set_git_backend = git_backend.set_backend
M.reset_git_backend = git_backend.reset_backend

--- Resolves the filesystem path for the ForgeStatus debug log.
...
function M._gitstatus_debug_log_path()
  ...
  local dir = (vim.fn.stdpath("state") or ".") .. "/forge"
