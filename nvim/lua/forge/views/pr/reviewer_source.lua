...
---@module 'blink.cmp'
---@class ForgeBlinkReviewerSource
---@field opts? table
---@field new? fun(opts?: table): ForgeBlinkReviewerSource
---@field enabled? fun(self: ForgeBlinkReviewerSource): boolean
---@field get_trigger_characters? fun(self: ForgeBlinkReviewerSource): string[]
---@field get_completions? fun(self: ForgeBlinkReviewerSource, ctx: table, callback: fun(result: table))
---@type ForgeBlinkReviewerSource
local source = {}
