...
local fold_presentation = require("forge.render.fold_presentation")

---@class ForgePlanFoldRange
---@field id string
---@field start_line integer
---@field end_line integer
---@field default_folded boolean

---@class ForgePlanFoldController
---@field range_by_id table<string, ForgePlanFoldRange>
...
---@return table<string, ForgePlanFoldRange>
...
---@return ForgePlanFoldController
function M.new()
  return setmetatable({
    range_by_id = {},
    folded_by_id = {},
