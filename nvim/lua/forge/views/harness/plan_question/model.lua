...
---@class ForgePlanQuestionReviewItem
...
---@param entry_list ForgePlanQuestionEntry[]
---@param answer table?
---@return integer
...
---@param entry ForgePlanQuestionEntry
---@param answer table?
---@return string
...
---@param elicitation table
---@return ForgePlanQuestionReviewItem[]
