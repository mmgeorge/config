...
---@class ForgeCommandSpecsModule
local M = {}

---@type ForgeStatusCommandSpec[]
M.specs = {
  ...
  { id = "next_hunk", label = "next hunk", desc = "Jump to the next hunk", modes = "n", pinned = false, views = { status = true, diff = true } },
  { id = "previous_hunk", label = "previous hunk", desc = "Jump to the previous hunk", modes = "n", pinned = false, views = { status = true, diff = true } },
  ...
  { id = "unstage", label = "unstage", desc = "Unstage hunk/file/selection or unignore file", modes = { "n", "x" }, visual = true, pinned = true, views = { status = true } },
  ...
  { id = "refresh", label = "refresh", desc = "Refresh Forge", modes = "n", pinned = true, views = { status = true, diff = true, review = true } },
  { id = "close", label = "close", desc = "Close Forge", modes = "n", pinned = true },
  { id = "help", label = "help", desc = "Show help", modes = "n", pinned = true },
  { id = "viewed", label = "viewed", desc = "Mark file as viewed", modes = { "n", "x" }, keymap = "review", visual = true, pinned = true, views = { review = true } },
  { id = "unviewed", label = "unviewed", desc = "Move file back to unviewed", modes = { "n", "x" }, keymap = "review", visual = true, pinned = true, views = { review = true } },
  ...
  harness = {
    ...
    { id = "cancel", label = "cancel", desc = "Cancel the active Harness turn", modes = { "n", "i" }, pinned = false,
      hints = { composer = function(state) if state.busy then return "cancel" end end,
        working_status = function() return "to interrupt" end } },
    ...
    { id = "open_artifact", label = "artifacts", desc = "Open a session artifact", modes = "n", pinned = true,
      hints = { review_status = function() return "open plan" end } },
    { id = "abort_plan", label = "abort plan", desc = "Abort the current plan and exit Plan mode", modes = "n", pinned = false,
      hints = { review_status = function() return "abort plan" end } },
    ...
    { id = "open_timeline", label = "open", desc = "Open the item linked by this timeline row", modes = "n", pinned = false },
    { id = "reopen_question", label = "feedback", desc = "Reopen pending Harness questions", modes = "n", pinned = false,
      hints = { question_status = function() return "open question" end } },
    ...
    { id = "close", label = "exit", desc = "Exit Harness", modes = "n", pinned = true,
      hints = { composer = function() return "exit (normal)" end } },
