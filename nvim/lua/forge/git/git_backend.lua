...
---@class ForgeGitBackendModule
---@field current ForgeGitBackend? injected backend; nil uses the process runner
...
---@param backend ForgeGitBackend? Mock backend implementation, or nil to use default process runner.
...
---@param cb ForgeGitTextCallback Callback receiving the command result table.
...
---@param cb ForgeGitTextCallback Final callback receiving the full command result table.
...
---@param command ForgeGitCommand Command arguments array.
---@param cb ForgeGitListCallback Callback receiving lines array, exit code, and combined output.
...
---@param cb fun(result: ForgeGitCommandResult) Callback receiving structured execution result.
...
---@param cb fun(result: ForgeGitCommandResult) Callback receiving execution result.
...
---@param args string[] Git command arguments.
---@param input? string Optional standard input text.
---@return ForgeGitCommandResult result Command execution result table.
