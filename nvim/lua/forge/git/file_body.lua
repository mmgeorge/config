...
---@return ForgeFileBodyResult result Formatted error outcome table.
...
---@param file ForgeStatusFile Status file entry descriptor.
---@param content string Raw file content string.
---@return ForgeFileBodyResult result Populated file body result table.
...
---@param file ForgeStatusFile Status file entry descriptor.
---@param callback fun(result: ForgeFileBodyResult) Completion callback function.
