...
---@alias ForgeIndexMutationDirection "stage"|"unstage"
---@alias ForgeIndexMutationTargetKind "hunk"|"tracked_file"|"untracked_file"|"added_file"

---@class ForgeIndexMutationTarget
---@field kind ForgeIndexMutationTargetKind
---@field path string
---@field original_path? string
---@field diff? string

---@class ForgeIndexMutationSpec
---@field direction ForgeIndexMutationDirection
---@field target_list ForgeIndexMutationTarget[]

---@class ForgeIndexMutationFailure
---@field target ForgeIndexMutationTarget
---@field message? string
---@field output? string
---@field code? integer
---@field args? string[]

---@class ForgeIndexMutationResult: ForgeMutationResult
---@field completed_target_list ForgeIndexMutationTarget[]
---@field hunk_count integer
---@field file_count integer
---@field failure? ForgeIndexMutationFailure

---@param root string
---@param direction ForgeIndexMutationDirection
---@param target ForgeIndexMutationTarget
---@return string[]? args
---@return string? input
---@return string? error
...
---@param spec ForgeIndexMutationSpec Stage/unstage mutation specification.
---@param callback fun(result: ForgeIndexMutationResult) Completion callback.
function M.execute_async(root, spec, callback)
  ...
  ---@param failure? ForgeIndexMutationFailure
