...
local function run()
  ...
  assert_true(vim.b[scratch_buf].forge_syntax_filetype == "rust", "syntax source scratch buffer missed parser filetype")
  ...
  assert_true(vim.b[diff_syntax.buf].forge_syntax_filetype == "rust", "diff syntax scratch buffer missed parser filetype")
