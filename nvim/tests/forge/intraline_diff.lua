...
local intraline = require("forge.render.intraline_diff")
...
local function run()
  ...
  assert_true(added.hl_group == "ForgeInlineAddBg", "insertion should use inline add highlight")
  ...
  assert_true(removed.hl_group == "ForgeInlineDeleteBg", "deletion should use inline delete highlight")
