...
local success, failure = xpcall(function()
  ...
  original(window)
  local transcript = input.open(first, window, { margin = 0, virtualedit = "" })
  assert(vim.wo[window].virtualedit == "", "view ignored its cursor boundary")
  ...
  assert(vim.wo[window].virtualedit == "", "cursor boundary changed on reentry")
