...
local annotation_model = require("forge.render.annotations")
local hunk_index = require("forge.render.hunk_index")
local layout = require("forge.render.layout")
local row_tree = require("forge.render.row_tree")
local source_model = require("forge.render.source")
local source_loader = require("forge.render.source_loader")
local syntax_context = require("forge.render.syntax_context")
local text_snapshot = require("forge.render.text_snapshot")
local decoration = require("forge.render.decoration")
local view_command_set = require("forge.shared.view_command_set")
local view_controller = require("forge.shared.view_controller")
local region_model = require("forge.render.region")
...
local function assert_region()
  ...
  local ns = vim.api.nvim_create_namespace("forge_region_test")
