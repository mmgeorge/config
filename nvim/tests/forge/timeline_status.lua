...
local ok, failure = pcall(function()
  ...
  local interaction_tree = require("forge.render.harness.interaction_tree")
  local status_render = require("forge.render.harness.timeline_status")
  local status_view = require("forge.views.harness.timeline_status")
  local presentation = require("forge.views.harness.question_presentation")
