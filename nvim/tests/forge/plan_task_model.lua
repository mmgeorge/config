...
local ok, failure = pcall(function()
  ...
  assert_true(row_has_highlight(buf, first_file_row, "src/plan.rs", "ForgeWalkthroughItemTitle"),
  ...
  assert_true(row_has_highlight(buf, first_owner_row, "Add", "ForgeWalkthroughActionAdd"),
