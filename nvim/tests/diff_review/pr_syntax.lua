...
local function run()
  ...
  assert_true(vim.wo[win].wrap == false, "PR overview should reuse GitStatus no-wrap window formatting")
  assert_true(vim.wo[win].linebreak == false, "PR overview should not enable linebreak")
