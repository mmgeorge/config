...
local function run()
  ...
  trigger_normal_mapping("j", find_hunk_row_after_file(buf, "collapse-parent-a.txt"))
  assert_true(
  ...
  trigger_normal_mapping("j", find_row(buf, "collapse-parent-a.txt"))
  assert_true(
  ...
  trigger_normal_mapping("D", find_row(buf, "delete-untracked.txt"))
  confirm_yes()
  ...
  trigger_normal_mapping("D", find_row(buf, "discard-modified.txt"))
  confirm_yes()
  wait_for(function()
  ...
  reset_calls()
  trigger_normal_mapping("D", find_row_after(buf, "discard-mixed.txt", find_row(buf, "Unstaged changes")))
  confirm_yes()
  wait_for(function()
  ...
  reset_calls()
  trigger_normal_mapping("D", find_row(buf, "discard-intent-added.txt"))
  confirm_yes()
  wait_for(function()
  ...
  reset_calls()
  trigger_normal_mapping("D", find_row(buf, "@@ +1 -1"))
  confirm_yes()
  wait_for(function()
  ...
  reset_calls()
  trigger_normal_mapping("D", find_row_after(buf, "@@ +1 -1", find_row(buf, "cursor-discard-a.txt")))
  confirm_yes()
  wait_for(function()
    return saw_system_call_containing("\tapply\t--reverse\t--whitespace=nowarn\t-")
  ...
  trigger_normal_mapping("D", discard_header_row)
  confirm_yes()
  wait_for(function()
  ...
  reset_calls()
  trigger_normal_mapping("D", find_row(buf, "discard-file-header-a.txt +1 -1"))
  confirm_yes()
  wait_for(function()
  ...
  trigger_normal_mapping("D", find_row(buf, "discard-added.txt"))
  confirm_yes()
  wait_for(function()
  ...
  reset_calls()
  trigger_normal_mapping("D", find_row(buf, "discard-staged-modified.txt"))
  confirm_yes()
  wait_for(function()
  ...
  reset_calls()
  trigger_normal_mapping("D", find_row(buf, "discard-staged-deleted.txt"))
  confirm_yes()
  wait_for(function()
  ...
  reset_calls()
  trigger_normal_mapping("D", find_row(buf, "discard-staged-new.txt"))
  confirm_yes()
  wait_for(function()
